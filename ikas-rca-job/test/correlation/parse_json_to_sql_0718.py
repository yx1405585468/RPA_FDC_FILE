...
class ParseAlgorithmSqlConfig:
    ...
    @staticmethod
    def parse_config(json_data: str) -> Dict[str, Union[str, Dict[str, str]]]:
        """
    ...
    def generate_sql_query(json_config: dict, algo_type: str, table_name: str, time_field: str, start_date: str,
                           end_date: str,
                           selected_fields: List[str]) -> Union[str, None]:
        """
        生成特定表的 SQL 查询语句。
        ...
        wat_key_mapping_table = f"doris_db.doris_wat_key_mapping_table_name"
        correlation_wafer_table = f"doris_db.doris_correlation_wafer_table_name"
    ...
    jsonData = '''
{
  ...
  "requestId": "269",
  "requestParam": {
  "correlation_filter_upload_id":"dadaadada",
  "uploadId":"dadaadada",
    "anomaly": {
      "analysis_type": "fdc",
      "chamber": "",
    ...
    # 执行解析函数并打印结果
    print(json.dumps(ParseAlgorithmSqlConfig.parse_config(jsonData)))
