...
class SplitDefectModelResults:
    ...
    def run(self) -> pyspark.sql.dataframe:
        ...
        res_all_update_missing_features.show(30)
...
if __name__ == "__main__":
    ...
    print(df_run_pandas.groupby(["LAYER_ID", 'label'])['WAFER_ID'].nunique().reset_index(drop=False).sort_values('LAYER_ID'))
