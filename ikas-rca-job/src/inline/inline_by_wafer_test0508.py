    ...
    def fit_pca_model(df: pyspark.sql.dataframe, grpby_list, columns_to_process,
        ...
        def get_model_result(df_run):
            ...
            if min(x_train.shape) > 2:
                ...
                res_top_select = FitInlineModelByWafer.construct_features_when_not_satisfied(df_run, pivot_result, x_train,
                                                                                             grpby_list, 'pca')
                return res_top_select
        ...
        def get_model_result(df_run):
            ...
            if x_train.shape[1] > 1 and y_train['label'].nunique() > 1:
                ...
                try:
                    ...
                    return FitInlineModelByWafer.construct_features_when_not_satisfied(df_run, pivot_result, x_train,
                ...
                res_top_select = FitInlineModelByWafer.construct_features_when_not_satisfied(df_run, pivot_result,
                                                                                             x_train,
                                                                                             grpby_list,
                                                                                             'classification')
                return res_top_select
