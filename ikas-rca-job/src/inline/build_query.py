...
def build_inline_query(select_condition_dict: dict, properties_config: dict) -> str:
    table_name = f"{properties_config['doris_db']}.{properties_config['doris_inline_wafer_summary_table']}"
    ...
    for keyword, value in select_condition_dict.items():
        ...
        if keyword in ["productId", "eqp", "tool", "chamber", "operNo", "lot"]:
