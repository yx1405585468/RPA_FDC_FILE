...
if __name__ == "__main__":
    ...
    df_pandas = pd.read_csv(
        "D:/Jupyterfiles/晶合MVAFDC_general开发/MVAanlysisDevelop/inline_algorithm/inline_case5_label_2.csv")
    # df_pandas = df_pandas[
    ...
    json_loads_dict = {"requestId": "269",
                       ...
                       "requestParam": {"dateRange": {"start": "2021-12-06 19:50:49", "end": "2024-03-06 19:50:49"},
                                        ...
                                        "mergeEqp": [],
                                        "mergeChamber": [],
                                        # "mergeOperno": [{"xx1": ["1C.CDG10", "1V.EQW10", "1U.PQW10", "TV.EQA20"]},
                                        #                 {"xx2": ["1V.PQW10", "1F.FQE10", "1U.CDG20", "TM.EQW10"]}],
                                        "mergeOperno": None
                                        }
                       }
