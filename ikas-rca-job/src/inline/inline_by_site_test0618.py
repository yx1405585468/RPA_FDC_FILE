...
class ExertInlineBySite:
    ...
    def check_site_columns(*site_columns_lists: List[str]):
        ...
        # if site_columns1 is not None:
        #     site_columns1 = list(set(site_columns1))
        #
        # if site_columns2 is not None:
        #     site_columns2 = list(set(site_columns2))
        #
        # if site_columns3 is not None:
        #     site_columns3 = list(set(site_columns3))
        #
        # if site_columns4 is not None:
        #     site_columns4 = list(set(site_columns4))
        #
        # if site_columns5 is not None:
        #     site_columns5 = list(set(site_columns5))
        #
        # not_empty_count = 0
        # label_site_columns = []
        # # 检查每个变量是否不为空
        # for site_grp in [site_columns1, site_columns2, site_columns3, site_columns4, site_columns5]:
        #     if site_grp is not None and len(site_grp) > 0:
        #         label_site_columns.append(site_grp)
        #         not_empty_count += 1
        #
        # if not_empty_count < 2:
        #     msg = "请至少指定两类不同的sites, 且不能为空"
        #     raise RCABaseException(msg)
    ...
    def fit_by_site_model(*site_columns_lists: List[str],
        ...
        # res_pandas.to_csv("inline_by_site_res_after.csv")
...
if __name__ == "__main__":
    ...
    #                                     "mergeChamber": [],
    #                                     "SiteColumns": {
    #                                         "site_grp1": ["SITE1_VAL", "SITE3_VAL", "SITE5_VAL", "SITE7_VAL", "SITE9_VAL"],
    #                                         "site_grp2": ["SITE2_VAL", "SITE4_VAL", "SITE6_VAL", "SITE8_VAL"],
    #                                     },
    #
    #                                     # "mergeOperno": []
    #                                     "mergeOperno": [{"1F.FQE10,1C.CDG10": ["1F.FQE10", "1C.CDG10"]},
