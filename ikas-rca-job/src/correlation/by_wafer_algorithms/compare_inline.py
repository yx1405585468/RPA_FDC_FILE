...
class PreprocessForInlineData(object):
    ...
    def integrate_columns(
        ...
        """
        df_merged = PreprocessForInlineData.integrate_single_column(
...
class CorrCompareInlineByWaferAlgorithm(
    PreprocessForInlineData, ProcessBaseDFByWAFER, CorrelationDetectAlgorithm
):
    ...
    def run(
        ...
        return CorrCompareInlineByWaferAlgorithm.__run_with_kwargs__(
    ...
    def __run_with_kwargs__(
        ...
        df_processed = PreprocessForInlineData(
            source_df,
